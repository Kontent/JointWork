...
class JointworkProfiler extends JProfiler {
	protected static $_instances = array();
	protected $_heap = array();

	public static function instance($prefix = 'Jointwork')
	{
	...
	public function start($name) {
		$item = JointworkProfilerItem::getInstance($name);
	...
	public function getAll() {
		return JointworkProfilerItem::getAll();
	}
}

class JointworkProfilerItem {
	protected static $_instances = array();
	...
	public static function getInstance($name) {
		if (empty(self::$_instances[$name])) {
			self::$_instances[$name] = new JointworkProfilerItem($name);
		}
